...
private fun TimerRoutineDetailsBody(
    ...
    Column(
        ...
        /*Button(
            onClick = onSellTimerRoutine,
            modifier = Modifier.fillMaxWidth(),
            enabled = !timerRoutineDetailsUiState.outOfStock
        ) {
...
//@Composable
//fun TimerRoutineDetailsScreenPreview() {
//    InventoryTheme {
//        TimerRoutineDetailsBody(
//            TimerRoutineDetailsUiState(
//                outOfStock = true,
//                timerRoutineDetails = TimerRoutineDetails(1, "Pen", "$100", "10")
//            ),
//            onSellTimerRoutine = {},
//            onDelete = {}
//        )
