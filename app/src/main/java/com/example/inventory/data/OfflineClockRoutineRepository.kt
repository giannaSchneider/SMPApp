...
class OfflineClockRoutineRepository(private val ClockRoutineDao: ClockRoutineDao) : ClockRoutineRepository {
    ...
    override suspend fun insertClockRoutine(routine: ClockRoutine) = ClockRoutineDao.insert(routine)

    override suspend fun deleteClockRoutine(routine: ClockRoutine) = ClockRoutineDao.delete(routine)

    override suspend fun updateClockRoutine(routine: ClockRoutine) = ClockRoutineDao.update(routine)
