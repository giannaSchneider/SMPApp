...
interface RoutinesRepository {
     ...
     */
    fun getAllTimerRoutinesStream(): Flow<List<TimerRoutine>>
     ...
     * Retrieve an routine from the given data source that matches with the [id].
     */
    fun getTimerRoutineStream(id: Int): Flow<TimerRoutine?>
    //fun getRoutineStream(id: Int): Flow<TimerRoutine?>

    /**
     * Insert Routine in the data source
     */
    suspend fun insertTimerRoutine(routine: TimerRoutine)

    /**
     * Delete Routine from the data source
     */
    suspend fun deleteTimerRoutine(routine: TimerRoutine)

    /**
     * Update routine in the data source
     */
    suspend fun updateTimerRoutine(routine: TimerRoutine)
